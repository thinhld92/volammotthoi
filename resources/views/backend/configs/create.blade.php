...
@section('content')
  ...
  <div class="card mb-4">
    <h5 class="card-header">{{ __('Create new config') }}</h5>
    <form 
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <input 
            ...
            class="form-control {{$errors->get('v') ? 'custom-invalid' : ''}}" 
        ...
        <div class="col-md-6">
          <label class="form-label" for="multicol-config_comment">{{__('Config comment')}} <span class="text-danger">(*)</span></label>
          <div class="input-group input-group-merge">
            <input
              type="text"
              name="config_comment"
        ...
        <div class="col-md-8 mt-5">
          <label class="form-label" for="multicol-image-input"><span class="text-danger">{{__('Dùng để hiển thị link image nếu cần, tìm hình rồi copy bỏ lên config value')}} </span></label>
          <div class="input-group input-group-merge">
            <input
              type="text"
              id="image-input"
