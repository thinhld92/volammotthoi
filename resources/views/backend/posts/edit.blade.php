  ...
  @method('put')
    <div class="col-12 col-lg-9">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            @php
                $current_category_id = old('category_id') ?? $post->category_id;
            @endphp
            ...
            >
              ...
              @foreach ($categories as $item)
                <option value="{{$item->id}}"
                  {{$current_category_id == $item->id ? 'selected' : ''}}  
                >
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-4">
              ...
              <input
                ...
                class="form-control dob-picker"
                placeholder="{{ __('YYYY-MM-DD') }}"
                value="{{old('banner_date') ?? $post->banner_date}}" 
              />
            </div>
            <div class="col-md-4">
    ...
    <div class="col-12 col-lg-3">
        ...
        <div class="card-body">
          <div class="mb-3">
            <img class="card-img button-click" 
              src="{{old('image') ?? $post->image ?? asset('backend/assets/img/functions/no-image.jpg')}}" 
              alt=""
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <img class="card-img button-click" 
            src="{{old('thumbnail') ?? $post->thumbnail ?? asset('backend/assets/img/functions/no-image.jpg')}}" 
            alt=""
